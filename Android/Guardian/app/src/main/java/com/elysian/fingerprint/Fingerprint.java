...
public class Fingerprint extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // STEPS :-
        // android version should be greater than marshmallow
        // device has fingerprint scanner
        // permission to use scanner
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            if (!fingerprintManager.isHardwareDetected()) {
                paraLabel.setText("Fingerprint scanner not detected in the device");
            } else if (ContextCompat.checkSelfPermission(this, Manifest.permission.USE_FINGERPRINT) != PackageManager.PERMISSION_GRANTED) {
                paraLabel.setText("Permission not granted to use fingerprint scanner");
            } else if (!keyguardManager.isKeyguardSecure()) {
                paraLabel.setText("Secure your phone by adding lock in Homescreen");
            } else if (!fingerprintManager.hasEnrolledFingerprints()) {
                paraLabel.setText("You should add atleast one fingerprint to use this application");
            } else {
                paraLabel.setText("Place your finger on scanner to access the application");
